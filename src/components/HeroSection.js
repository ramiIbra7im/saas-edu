                ...
                <div className="row align-items-center">
                    ...
                    >
                        ...
                        <div className="d-flex gap-3 justify-content-center justify-content-md-start mt-4">
                            <a href="/register" className="btn btn-primary btn-lg">جرّب الآن مجانًا</a>
                            <a href="#features" className="btn btn-outline-primary btn-lg">مميزات النظام</a>
                        </div>
                    </motion.div>
                    ...
                    >
                        <Image src={heroImage} alt="Hero" className="img-fluid" priority />
                    </motion.div>
                </div>
            </div>
        </section>
